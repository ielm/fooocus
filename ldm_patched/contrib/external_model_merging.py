...
def save_checkpoint(
    ...
    full_output_folder, filename, counter, subfolder, filename_prefix = (
        ldm_patched.utils.path_utils.get_save_image_path(filename_prefix, output_dir)
    )
    prompt_info = ""
    ...
    if model.model.model_type == ldm_patched.modules.model_base.ModelType.EPS:
        ...
        model.model.model_type == ldm_patched.modules.model_base.ModelType.V_PREDICTION
    ):
    ...
    ldm_patched.modules.sd.save_checkpoint(
        output_checkpoint, model, clip, vae, clip_vision, metadata=metadata
    )
...
class CLIPSave:
    ...
    def save(self, clip, filename_prefix, prompt=None, extra_pnginfo=None):
        ...
        for prefix in ["clip_l.", "clip_g.", ""]:
            ...
            current_clip_sd = ldm_patched.modules.utils.state_dict_prefix_replace(
...
class VAESave:
    ...
    def save(self, vae, filename_prefix, prompt=None, extra_pnginfo=None):
        ...
        ldm_patched.modules.utils.save_torch_file(
            vae.get_sd(), output_checkpoint, metadata=metadata
        )
        return {}
