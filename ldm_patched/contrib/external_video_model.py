...
class SVD_img2vid_Conditioning:
            ...
            "required": {
                ...
                "width": (
                    "INT",
                    {
                        "default": 1024,
                        "min": 16,
                        "max": ldm_patched.contrib.external.MAX_RESOLUTION,
                        "step": 8,
                    },
                ),
                "height": (
    ...
    def encode(
        ...
        pixels = ldm_patched.modules.utils.common_upscale(
...
class ImageOnlyCheckpointSave(
    ldm_patched.contrib.external_model_merging.CheckpointSave
):
    ...
    def save(
        ...
        ldm_patched.contrib.external_model_merging.save_checkpoint(
            model,
            clip_vision=clip_vision,
            vae=vae,
