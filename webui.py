    ...
    with gr.Row():
                    ...
                    with gr.TabItem(label="Describe") as desc_tab:
                        with gr.Row():
                            ...
                            with gr.Column():
                                ...
                                desc_image_size = gr.Textbox(
                                    label="Image Size and Recommended Size",
                                    elem_id="desc_image_size",
                                    visible=False,
                                )
                                gr.HTML(
        ...
        if not args_manager.args.disable_preset_selection:
            ...
            def preset_selection_change(preset, is_generating):
                ...
                preset_prepared["base_model"], preset_prepared["lora_downloads"] = (
                ...
                return modules.meta_parser.load_parameter_button_click(
                    json.dumps(preset_prepared), is_generating
                )
