...
preprocessor_config_path = os.path.join(
    safety_checker_repo_root, "configs", "preprocessor_config.json"
)
...
class Censor:
    ...
    def init(self):
        if self.safety_checker_model is None and self.clip_image_processor is None:
            ...
            self.safety_checker_model = ModelPatcher(
